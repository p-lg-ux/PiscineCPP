...
/*   Updated: 2023/06/02 15:33:53 by pgros            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	_is_signed = false;
	std::cout << GREEN << "Copy constructor of AForm called." << RESET << std::endl;
}
	...
	_exec_grade(exec_grade)
{
	...
	_is_signed = false;
	std::cout << GREEN << "Parameters constructor of AForm called." << RESET << std::endl;
}
